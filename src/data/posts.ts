...
export const posts: Post[] = [
  {
    ...
    authorName: 'Dec 2023',
    description: 'Implemented transfer learning & Aspect-Based Sentiment Analysis with 3 advanced LLM models (DistilBERT, DeBERTa, PyABSA) in Python to provide precise insights beyond standard Yelp ratings',
